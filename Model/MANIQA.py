...
class SwinTransformer(nn.Module):
    def __init__(self, patches_resolution, depths, num_heads,
...
class MANIQA(nn.Module):
    def __init__(self, depths, embed_dim=72, num_outputs=1, patch_size=8, drop=0.1, 
                    window_size=4, dim_mlp=768, num_heads=[4, 4],
